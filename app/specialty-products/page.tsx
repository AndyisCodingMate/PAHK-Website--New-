...
export default function SpecialtyProducts() {
  ...
  const specialtyProducts = [
    ...
    {
      name: "PACIFIC CAL™",
      description: "A specialized calcium-based product for improving fruit quality and plant health.",
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-green-800 text-white">
        <div className="absolute inset-0 overflow-hidden">
          <Image
            src="/images/specialty-products.jpg"
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Specialty Products</h1>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-green-800">Our Specialty Products</h2>
        <p className="mt-4 text-lg text-gray-600">
          Discover our range of innovative specialty products designed to meet specific agricultural needs.
        </p>
        ...
        <div className="mt-16 bg-green-50 p-8 rounded-lg">
          <h3 className="text-2xl font-bold text-green-800">Looking for More?</h3>
          <p className="mt-2 text-lg text-gray-700">
            Our range of specialty products extends beyond what's listed here. If you're interested in learning about
            our full range of specialty products or have specific requirements, we encourage you to get in touch with
            our team.
          </p>
          <div className="mt-6">
            <Link
            ...
            >
              Inquire About More Products <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
        </div>
      </div>
