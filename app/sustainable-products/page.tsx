    ...
    <div className="bg-white">
      ...
      <div className="relative bg-green-800 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Sustainable Products</h1>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-green-800">Our Sustainable Products</h2>
        <p className="mt-4 text-lg text-gray-600">
          At Pacific Agriscience, we are committed to developing and providing sustainable agricultural products that
          minimize environmental impact while maximizing effectiveness. Our sustainable product line includes organic
          herbicides, biological insecticides, biofertilizers, and natural soil conditioners.
        </p>
        ...
        <div className="mt-12 bg-gray-50 p-8 rounded-lg">
          <h3 className="text-2xl font-bold text-green-800">Product Brochure</h3>
          <p className="mt-4 text-lg text-gray-700">
            Our comprehensive brochure provides detailed information about our sustainable product portfolio, including
            technical specifications, application guidelines, and benefits.
          </p>
          <div className="mt-6">
            <a
      ...
      <div className="bg-gray-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold tracking-tight text-green-800">Benefits of Sustainable Agriculture</h2>
          <div className="mt-8 grid gap-8 md:grid-cols-3">
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold text-green-700">Environmental Protection</h3>
              <p className="mt-2 text-gray-600">
                Our sustainable products help reduce chemical runoff, protect beneficial organisms, and preserve
                biodiversity.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold text-green-700">Long-term Soil Health</h3>
              <p className="mt-2 text-gray-600">
                Biological products improve soil structure, enhance nutrient cycling, and promote beneficial
                microorganisms.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold text-green-700">Regulatory Compliance</h3>
              <p className="mt-2 text-gray-600">
                Stay ahead of evolving regulations with products that meet or exceed environmental standards and organic
                certifications.
              </p>
            </div>
          </div>
