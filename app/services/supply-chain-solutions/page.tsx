    ...
    <div className="bg-white">
      ...
      <div className="relative bg-green-800 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">Supply Chain Solutions</h1>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900">Our Supply Chain Services</h2>
        <p className="mt-4 text-lg text-gray-600">
          Pacific Agriscience provides comprehensive supply chain solutions to streamline your agricultural operations:
        </p>
